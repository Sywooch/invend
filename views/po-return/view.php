...
<div class="po-view">
    <div class="ibox-title text-right">
        <a href="<?= Url::toRoute(['/po-return/update', 'id' => $model->id]) ?>" class="btn btn-white"><i class="fa fa-pencil"></i> Edit </a>
        <a href="<?= Url::toRoute(['/po-return/print', 'id' => $model->id]) ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Invoice </a>
    </div>
