                                ...
                                <tr class="po_return_line-item"><!-- widgetBody -->
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            echo Html::activeTextInput($modelPoReturnLine, "[{$i}]item_code", ['maxlength' => true, 'class' => 'form-control']); //Field
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            echo Html::activeTextInput($modelPoReturnLine, "[{$i}]sub_total", ['maxlength' => true, 'class' => 'form-control','onchange' => 'getPoReturnTotal(this);this.oldvalue = this.value;']); //Field
