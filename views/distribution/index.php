...
$this->title = Yii::t('app', 'Distribution List');
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title text-right">
                <a href="<?= Url::toRoute(['/distribution/create']) ?>" target="_blank" class="btn btn-primary"><i class="fa fa-pencil"></i>New Distribution</a>
                <div class="ibox-tools">
                    <a class="collapse-link">
                        <i class="fa fa-chevron-up"></i>
                    </a>
