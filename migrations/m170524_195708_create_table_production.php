...
class m170524_195708_create_table_production extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('production', [
            ...
            'start_weight' => $this->decimal()->notNull(),
            'end_weight' => $this->decimal()->notNull(),
            'net_weight' => $this->decimal()->defaultValue(0),
            'quantity_produced' => $this->integer()->notNull()->defaultValue(0),
            'quantity_wasted' => $this->integer()->notNull()->defaultValue(0),
            'rolls_wasted' => $this->decimal()->notNull()->defaultValue(0),
