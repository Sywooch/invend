...
class Production extends ActiveRecord
{
    ...
    {
        return [
            [['name', 'end_weight', 'start_weight', 'quantity_produced', 'actual_prod_date'], 'required'],
            [['user_id', 'quantity_produced', 'quantity_wasted', 'active', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
            [['start_weight', 'end_weight', 'rolls_wasted'], 'number'],
            [['start_weight', 'end_weight'], 'number', 'min' => 1],
            [['quantity_produced'], 'integer', 'min' => 1],
            [['net_weight'], 'number', 'min' => 0],
            [['quantity_produced', 'quantity_wasted', 'rolls_wasted', 'net_weight'], 'default', 'value' => 0],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name' => Yii::t('app', 'Name'),
            'start_weight' => Yii::t('app', 'Start Weight(kg)'),
            'end_weight' => Yii::t('app', 'End Weight(kg)'),
            'net_weight' => Yii::t('app', 'Net Weight(kg)'),
            'quantity_produced' => Yii::t('app', 'Bags Produced'),
            'quantity_wasted' => Yii::t('app', 'Bags Wasted'),
            'rolls_wasted' => Yii::t('app', 'Rolls Wasted(kg)'),
