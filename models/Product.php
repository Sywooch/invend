...
class Product extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['product_category_id', 'default_location_id', 'last_vendor_id', 'product_type_id'], 'default', 'value' => 1],
            [['cost','normal_price', 'retail_price', 'wholesale_price', 'length', 'width', 'height', 'weight', 'reorder_point', 'reorder_quantity'], 'default', 'value' => 0],
            [
                'item_name', 'unique', 
