...
class VendorSearch extends Vendor
{
    ...
    {
        return [
            [['id', 'user_id', 'active', 'tax', 'currency_id', 'payment_method_id', 'taxing_scheme_id', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
            [['balance', 'credit', 'discount'], 'number'],
            [['number', 'name', 'address', 'contact', 'phone', 'fax', 'email', 'website', 'payment_terms', 'time', 'remarks'], 'safe'],
        ];
    }
