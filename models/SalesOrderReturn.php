...
/**
 * This is the model class for table "sales_order_return".
 *
 * @property integer $id
 ...
 * @property SalesOrderReturnLines[] $salesOrderReturnLines
 */
class SalesOrderReturn extends ActiveRecord
{
    public $count = 1;
    /**
     * @inheritdoc
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getSalesOrderReturnLines()
    {
        return $this->hasMany(SalesOrderReturnLines::className(), ['sales_order_return_id' => 'id']);
    }
}
